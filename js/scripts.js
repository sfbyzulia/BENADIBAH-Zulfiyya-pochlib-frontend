document.addEventListener('DOMContentLoaded', () => {
    ...
    const hrElement = pochListHeader.nextElementSibling;
    if (hrElement && hrElement.tagName === 'HR') {
        hrElement.classList.add('pochlist-hr');
    }
    ...
    function showSearchForm() {
        ...
        `;
        myBooksDiv.appendChild(searchResultsTitle);
}
    }
    ...
    function searchBooks() {
        ...
        fetch(`https://www.googleapis.com/books/v1/volumes?q=${query}`)
            ...
            .then(data => {
                ...
                // Show the results title and hr after the search form
                let searchResultsTitle = document.getElementById('searchResultsTitle');
                if (searchResultsTitle) {
                    searchResultsTitle.classList.remove('hidden');
                    const searchForm = document.getElementById('searchForm');
                    searchForm.insertAdjacentElement('afterend', searchResultsTitle);
                }
            })
    ...
    function displaySearchResults(books) {
        ...
        if (!searchResultsTitle) {
            ...
            searchResultsTitle.innerHTML = `
                ...
                <h2>Résultats de recherche</h2>
            `;
            myBooksDiv.insertBefore(searchResultsTitle, searchResults);
        }
        searchResultsTitle.classList.remove('hidden');
    ...
    function displayPochList() {
        ...
        newPochListContainer.classList.add('pochlist-content'); // Add the class for styling
        myBooksDiv.appendChild(newPochListContainer);
